...
area_a_ser_pintada = int(input('Digite a área a ser pintada em metros² '))
...
print(f'Você deverá usar {numero_de_latas} latas de 18 litros mais {numero_de_galoes} galoes de 3.6 litros, no valor de'
      f'R$ {valor_total}')
